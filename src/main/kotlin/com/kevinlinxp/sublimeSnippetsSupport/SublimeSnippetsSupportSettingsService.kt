...
class SublimeSnippetsSupportSettingsService : PersistentStateComponent<SublimeSnippetsSupportSettings> {
    ...
    companion object {
        ...
        fun getInstance(): SublimeSnippetsSupportSettingsService =
                ServiceManager.getService(SublimeSnippetsSupportSettingsService::class.java)
    }
    ...
    fun reloadSublimeSnippetsAsLiveTemplates() {
        ...
        try {
            ...
            if (!rootDir.exists() || !rootDir.isDirectory()) {
                logger.error("Invalid root directory. ${errorMessage(sublimeSnippetsRoot)}")
                return
            }
            ...
            logger.error("Exception (${e.message}) occurred while parsing snippets. ${errorMessage(sublimeSnippetsRoot)}", e)
        }
    }
