// Generated from /Users/kelin/Work/kelin/SublimeSnippetsSupport/src/main/antlr/SublimeSnippetContentParser.g4 by ANTLR 4.7
...
public class SublimeSnippetContentParser extends Parser {
	...
	public final SnippetContext snippet() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << TextCharacter) | (1L << FieldUnbracketed) | (1L << FieldBracketed) | (1L << FieldBracketedStart))) != 0)) {
				{
				setState(18);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public static class FieldBracketedWithPlaceholderContext extends ParserRuleContext {
		public TerminalNode FieldBracketedStart() { return getToken(SublimeSnippetContentParser.FieldBracketedStart, 0); }
		public TerminalNode VarNameAndPlaceholderStart() { return getToken(SublimeSnippetContentParser.VarNameAndPlaceholderStart, 0); }
	...
	public final FieldBracketedWithPlaceholderContext fieldBracketedWithPlaceholder() throws RecognitionException {
		...
		try {
			...
			{
			setState(43);
			match(FieldBracketedStart);
			setState(44);
			match(VarNameAndPlaceholderStart);
			setState(49);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << FieldUnbracketed) | (1L << FieldBracketed) | (1L << FieldBracketedStart) | (1L << Inside_TextCharacter))) != 0)) {
				{
				setState(47);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public static class FieldBracketedWithSubstitutionContext extends ParserRuleContext {
		public TerminalNode FieldBracketedStart() { return getToken(SublimeSnippetContentParser.FieldBracketedStart, 0); }
		public TerminalNode VarNameAndSubstitutionStart() { return getToken(SublimeSnippetContentParser.VarNameAndSubstitutionStart, 0); }
		public TerminalNode RegexpReplacementAndOptions() { return getToken(SublimeSnippetContentParser.RegexpReplacementAndOptions, 0); }
		public TerminalNode FieldBracketedEnd() { return getToken(SublimeSnippetContentParser.FieldBracketedEnd, 0); }
	...
	public final FieldBracketedWithSubstitutionContext fieldBracketedWithSubstitution() throws RecognitionException {
		...
		try {
			...
			match(FieldBracketedStart);
			setState(55);
			match(VarNameAndSubstitutionStart);
			setState(56);
			match(RegexpReplacementAndOptions);
			setState(57);
			match(FieldBracketedEnd);
			}
		}
	...
	public static final String _serializedATN =
		...
		"\3\5\3\5\3\6\3\6\3\7\6\7*\n\7\r\7\16\7+\3\b\3\b\3\b\3\b\7\b\62\n\b\f\b"+
		"\16\b\65\13\b\3\b\3\b\3\t\3\t\3\t\3\t\3\t\3\t\2\2\n\2\4\6\b\n\f\16\20"+
		"\2\2\2>\2\26\3\2\2\2\4\32\3\2\2\2\6\"\3\2\2\2\b$\3\2\2\2\n&\3\2\2\2\f"+
		")\3\2\2\2\16-\3\2\2\2\208\3\2\2\2\22\25\5\6\4\2\23\25\5\4\3\2\24\22\3"+
		"\2\2\2\24\23\3\2\2\2\25\30\3\2\2\2\26\24\3\2\2\2\26\27\3\2\2\2\27\3\3"+
		"\2\2\2\30\26\3\2\2\2\31\33\7\3\2\2\32\31\3\2\2\2\33\34\3\2\2\2\34\32\3"+
		"\2\2\2\34\35\3\2\2\2\35\5\3\2\2\2\36#\5\b\5\2\37#\5\n\6\2 #\5\16\b\2!"+
		"#\5\20\t\2\"\36\3\2\2\2\"\37\3\2\2\2\" \3\2\2\2\"!\3\2\2\2#\7\3\2\2\2"+
		"$%\7\4\2\2%\t\3\2\2\2&\'\7\5\2\2\'\13\3\2\2\2(*\7\7\2\2)(\3\2\2\2*+\3"+
		"\2\2\2+)\3\2\2\2+,\3\2\2\2,\r\3\2\2\2-.\7\6\2\2.\63\7\t\2\2/\62\5\6\4"+
		"\2\60\62\5\f\7\2\61/\3\2\2\2\61\60\3\2\2\2\62\65\3\2\2\2\63\61\3\2\2\2"+
		"\63\64\3\2\2\2\64\66\3\2\2\2\65\63\3\2\2\2\66\67\7\b\2\2\67\17\3\2\2\2"+
		"89\7\6\2\29:\7\n\2\2:;\7\13\2\2;<\7\b\2\2<\21\3\2\2\2\t\24\26\34\"+\61"+
		"\63";
